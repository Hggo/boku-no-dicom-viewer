...
export default class SeriesScrollButton extends ScrollButton {
    ...
    protected treatScroll = function (direction: number) {
        ...
        if (direction > 0) {
            ...
            this.dicomViewer.frameIndex = this.dicomViewer.frameIndex < this.dicomViewer.instance.numberOfFrames - 1 ? this.dicomViewer.frameIndex + 1: this.dicomViewer.frameIndex;
        }
